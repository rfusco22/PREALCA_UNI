document.addEventListener("DOMContentLoaded", () => {
  ...
  // --- VERIFICA QUE ESTAS LÍNEAS ESTÉN CORREGIDAS ---
  const editUserDocPrefixInput = document.getElementById("documento_type_user_edit");
  const editUserDocNumberInput = document.getElementById("documento_number_user_edit");
