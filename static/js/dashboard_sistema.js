document.addEventListener("DOMContentLoaded", () => {
  ...
  const editUserRolInput = document.getElementById("rol_user_edit"); // <-- ADDED FOR ROBUSTNESS
    ...
    fetch(`/api/admin/users/${userId}`)
      ...
      .then((user) => {
        ...
        if (editUserRolInput) {
            ...
            console.error("Could not find the element with ID 'rol_user_edit'.");
        }
        
        if(editUserStatusInput) {
